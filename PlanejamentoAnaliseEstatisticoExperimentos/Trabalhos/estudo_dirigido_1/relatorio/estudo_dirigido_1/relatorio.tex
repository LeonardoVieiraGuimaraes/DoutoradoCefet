...
Esta seção apresenta os resultados obtidos através das simulações computacionais \cite{morettin2010} e os discute, relacionando-os com a teoria estatística \cite{fisher1925}. Incluem-se tabelas, gráficos e análises quantitativas sobre a manifestação do Teorema Central do Limite e a validação dos Intervalos de Confiança.
