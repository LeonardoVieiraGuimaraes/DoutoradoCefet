...
\section{Observação dos Resultados, Cálculos Analíticos e Análise de Acurácia}

Esta subseção reúne toda a análise dos resultados, os cálculos analíticos e a avaliação da acurácia dos métodos numéricos utilizados. A análise foi realizada a partir da comparação entre os valores numéricos obtidos nas simulações e as soluções analíticas conhecidas para cada caso físico. As principais equações utilizadas foram:
