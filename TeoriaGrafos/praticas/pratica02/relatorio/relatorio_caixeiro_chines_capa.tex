...
Nas instâncias analisadas (teste, gr17.tsp, gr15.tsp e gr21.tsp), observou-se que o emparelhamento ótimo realizado pelo algoritmo ocorreu entre os vértices \textbf{a, b} e \textbf{e, d}, tornando-os de grau par e viabilizando a existência do circuito euleriano. Essa solução é resultado direto do algoritmo de emparelhamento mínimo, que busca pares de vértices de grau ímpar com menor custo de ligação. A recorrência desse emparelhamento em diferentes instâncias evidencia a robustez e a consistência da abordagem utilizada.
